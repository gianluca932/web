...
import { DATA as DATA_EN } from "@/data/resume.en";
import { DATA as DATA_IT } from "@/data/resume.it";
...
import WorkedWithBar from "@/components/worked-with-bar";
...
export default function Page({
  ...
  const DATA = locale === "it" ? DATA_IT : DATA_EN;
  return (
    <main className="flex flex-col min-h-[100dvh] space-y-10">
          ...
          <div className="gap-2 flex justify-between">
            <div className="flex-col flex flex-1 space-y-1.5">
              <BlurFadeText
                ...
                yOffset={8}
                text={t("hero.hi", { name: DATA.name.split(" ")[0] })}
              />
              <BlurFadeText
      ...
      <section id="about">
        <BlurFade delay={BLUR_FADE_DELAY * 3}>
          <h2 className="text-xl font-bold">{t("sections.about.title")}</h2>
        </BlurFade>
      ...
      <BlurFade delay={BLUR_FADE_DELAY * 5}>
        <section id="work">
          <WorkedWithBar label={t("sections.workedWith")} clients={CLIENTS} />
        </section>
      </BlurFade>
      <section id="work">
